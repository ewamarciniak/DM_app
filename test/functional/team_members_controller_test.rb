...
class TeamMembersControllerTest < ActionController::TestCase
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post :create, team_member: { experience_level: @team_member.experience_level, lead: @team_member.lead, qualification: @team_member.qualification, team: @team_member.team }
    end
  ...
  test "should update team_member" do
    put :update, id: @team_member, team_member: { experience_level: @team_member.experience_level, lead: @team_member.lead, qualification: @team_member.qualification, team: @team_member.team }
    assert_redirected_to team_member_path(assigns(:team_member))
  end
